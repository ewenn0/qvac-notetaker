...
export const LLM_MODELS: ModelOption[] = [
  { id: 'QWEN3_600M_INST_Q4', label: 'Qwen3 0.6B Instruct Q4', kind: 'llm', sizeHint: '~450 MB' },
  { id: 'LLAMA_3_2_1B_INST_Q4_0', label: 'Llama 3.2 1B Instruct Q4', kind: 'llm', sizeHint: '~770 MB' },
  { id: 'QWEN3_1_7B_INST_Q4', label: 'Qwen3 1.7B Instruct Q4', kind: 'llm', sizeHint: '~1.1 GB' },
  { id: 'QWEN3_4B_INST_Q4_K_M', label: 'Qwen3 4B Instruct Q4', kind: 'llm', sizeHint: '~2.5 GB' }
]
